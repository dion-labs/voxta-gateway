...
# We don't have a single place for version in docs yet, but let's check index.md or similar
# For now, we'll just log it. Consistency with voxta-client would mean updating a version string in docs.
